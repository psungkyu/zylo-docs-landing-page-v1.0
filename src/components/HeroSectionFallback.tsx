...
export default function HeroSectionFallback({
  defaultOpenDocScore,
}: HeroSectionFallbackProps) {
  const [scrollY, setScrollY] = React.useState(0);
  const [docPhase, setDocPhase] = React.useState<"initial" | "typing">(
    "initial"
  );
  ...
  const handleCopyInstallCommand = async () => {
    try {
      ...
      posthog.capture("install_command_copied", { command: installCommand });
  ...
  const handleOpenDocScore = () => {
    setDocScoreOpen(true);
    posthog.capture("doc_score_modal_opened", { source: "hero_widget" });
  };
              ...
              <div className="p-5 border-b border-blue-500/10">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    size="sm"
                    disabled
                    className="h-10 shrink-0 bg-blue-500/50 text-white border-0 cursor-not-allowed"
                  >
                ...
                <p className="mt-2 text-xs text-muted-foreground">
                  Graph view coming soon. Get your doc score.
                </p>
                <Button
                  type="button"
                  variant="outline"
