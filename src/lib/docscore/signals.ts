...
export function extractSignals(pages: ParsedPage[]): Signals {
  ...
  return {
    categoryDescriptions: hasPhrase(allText, [
      "overview",
      "about",
      "product",
      "category",
    ...
    useCaseDescriptions: hasPhrase(allText, [
      "use case",
      "use-case",
      "getting started",
      "scenario",
    ]),
    comparisonPages: hasPhrase(allText, [
      "compare",
      "vs ",
      "alternative",
      "competitor",
    ...
    integrationLists: hasPhrase(allText, [
      "integration",
      "connect",
      "api key",
      "webhook",
    ]),
    customerProof: hasPhrase(allText, [
      "customer",
      "case study",
      "testimonial",
      "logo",
    ...
    securityCompliance: hasPhrase(allText, [
      "security",
      "compliance",
      "soc",
      "gdpr",
    ...
    quickstart: hasPhrase(allText, [
      "quickstart",
      "quick start",
      "5 minute",
      "in 5 min",
    ]),
    gettingStarted: hasPhrase(allText, [
      "getting started",
      "getting-started",
      "introduction",
    ]),
    authentication: hasPhrase(allText, [
      "auth",
      "login",
      "token",
      "api key",
    ...
    authInstructions: hasPhrase(allText, [
      "authenticate",
      "authorization",
      "header",
      "credentials",
    ]),
    apiReference: hasPhrase(allText, [
      "api reference",
      "endpoint",
      "rest api",
      "graphql",
    ...
    requestBodies: hasPhrase(allText, [
      "request body",
      "request body",
      "post body",
      "parameters",
    ]),
    requestParams: hasPhrase(allText, [
      "parameter",
      "query string",
      "path variable",
    ]),
    responseSchemas: hasPhrase(allText, [
      "response",
      "schema",
      "field",
      "property",
